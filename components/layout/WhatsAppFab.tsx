...
export function WhatsAppFab() {
  return (
    <a
      ...
      rel="noopener"
      aria-label="WhatsApp"
      className="fixed bottom-5 right-5 z-[55] flex h-12 w-12 items-center justify-center rounded-full bg-selva shadow-[0_18px_36px_-16px_rgba(29,29,29,.7)] transition-[transform,background-color] duration-300 hover:-translate-y-[3px] hover:bg-whatsapp md:bottom-7 md:right-7 md:h-14 md:w-14"
    >
      <svg className="h-[22px] w-[22px] md:h-[26px] md:w-[26px]" viewBox="0 0 24 24" fill="#F8F5F0">
